  ...
  return (
    <section className="sl-store-header" aria-label="Store header">
      <style>{`
        ...
        .sl-store-header__powered a::after {
          content: '';
          position: absolute;
          bottom: -2px;
          left: 0;
      ...
      <div className="sl-store-header__inner">
        ...
        <div className="sl-store-header__right">
          <div className="sl-store-header__trust">
            {paymentCount > 0 && (
              <div className="sl-chip" role="button" aria-label="Payment methods" tabIndex={0}>
            ...
            {deliveryCount > 0 && (
              <div className="sl-chip" role="button" aria-label="Delivery options" tabIndex={0}>
