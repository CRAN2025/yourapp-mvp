...
| 2025-08-29 | v1.3.1_UI_UX_WHATSAPP_PER_CARD | INTEGRATION | **PER-CARD WHATSAPP CTA SYSTEM** - Remove floating FAB, add comprehensive per-card WhatsApp buttons with analytics, accessibility, and visibility logic | Senait | ✅ APPROVED | Agent | ✅ Completed | Baseline: v1.3_UI_UX_WHATSAPP |
